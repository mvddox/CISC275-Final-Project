...
const QUESTION_2: BasicQuestionType = {instruction: "Are people are of value to you?", answers:["Yes", "Mayhaps", "No"], id: 1}
const QUESTION_3: BasicQuestionType = {instruction: "Do you want to make the world a better place?", answers:["Yes", "No"], id: 2}
